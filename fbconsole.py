...
AUTH_SUCCESS_HTML = """
You have successfully logged in to facebook with Muvidb.
...
def oauth_url(app_id, redirect_uri, auth_scope):
    """Generates a url to an oath authentication dialog.
      ...
      https://www.facebook.com/dialog/oauth?scope=publish_stream&redirect_uri=http%3A%2F%2F127.0.0.1%3A8080%2F&response_type=token&client_id=160022564142819
    """
